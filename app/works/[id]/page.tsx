    ...
    <div className="stack gap-20">
      <div className="wrapper stack gap-8">
          <div className="project-card-title">
            ...
            <div className="w-full relative h-[880px] mx-auto shadow-sm border border-transparent group-hover:shadow-xl group-hover:border-blue-600/25 rounded-3xl overflow-hidden transition duration-300 ease-in-out">
              <Image
                placeholder="empty"
                fill
                quality={100}
