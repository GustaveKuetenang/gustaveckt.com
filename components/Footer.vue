...
<template>
  <nav
    class="flex flex-col justify-center items-center space-y-6 max-w-7xl mx-auto py-10 mt-14">
    <div>
      <NuxtLink to="/" class="text-2xl font-semibold">
        Gustave<span class="text-blue-600"> CKT</span>
      </NuxtLink>
    </div>
    ...
    <p class="text-gray-500">
      &copy; Designed by <span class="text-blue-600">Gustave
        CKT</span>
    </p>
  </nav>
</template>
